...
The following parameters are available in the `isoc::elastalert` class.
...
Default value: `'elastalert-correlation'`
...
Default value: `'elastalert_config.yaml'`
...
Data type: `Variant[ Resource, Array, String, Undef ]`
